      ...
      <div className="w-full px-4 sm:px-8 lg:px-[5%] py-12 bg-white text-gray-800">
        ...
        {wishlist.length === 0 ? (
          <div className="text-center py-10 text-gray-500">
            <i className="ri-emotion sad line text-2xl mr-2"></i> No Items in
            Your Wishlist!
          </div>
        ) : (
          <div className="overflow-hidden hidden md:block">
            <table className="w-full text-left border-separate border-spacing-y-6">
              <thead>
                <tr className="text-sm text-gray-500 border-b border-gray-500">
                  <th></th>
                  ...
                  >
                    ...
                    <td className="text-center">
                      <span className="inline-flex items-center gap-1 text-green-600 text-sm font-medium">
                        <i className="ri-checkbox-circle-line text-lg"></i> In
                        Stock
                      </span>
                    </td>
        ...
        <div className="md:hidden space-y-6">
          {wishlist.map((product) => (
            <div className="bg-white border shadow-sm rounded-xl px-4 py-4 flex flex-col gap-4">
              ...
              <div className="text-green-600 text-sm font-medium flex items-center justify-start">
