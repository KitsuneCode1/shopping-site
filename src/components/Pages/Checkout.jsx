          ...
          <div className="lg:col-span-2 bg-white p-8 border rounded-xl shadow-sm">
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="md:col-span-2">
                ...
                <select className="w-full border rounded-md px-4 py-2 outline-none">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="03, Israel Afolabi Street, Whitesand."
                  className="w-full border rounded-md px-4 py-2"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="onyekachichimezie@gmail.com"
                  className="w-full border rounded-md px-4 py-2"
                />
              </div>
          ...
          <div className="bg-gray-50 p-8 rounded-xl border h-fit shadow-sm">
            ...
            <div className="mt-6 text-sm">
              <label className="flex items-center gap-2 text-xs">
                ...
                I Have Read And Agree To The Website's <span className="inline text-blue-600 underline cursor-pointer">Terms And Conditions</span>
              </label>
            </div>
